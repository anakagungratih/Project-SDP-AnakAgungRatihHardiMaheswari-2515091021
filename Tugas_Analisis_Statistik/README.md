...
2. Tingkat_Churn_Persen ~ Pendapatan_Tahunan_Miliar_IDR
   Persamaan Regresi:
Persamaan regresi: Tingkat_Churn_Persen = 18.78 + 0.196806 × Pendapatan_Tahunan_Miliar_IDR - 0.398958 × Nilai_Pelanggan_Juta_IDR
...
- Scatter Plot
  ![Garis Regresi Linear Tingkat_Churn_Persen ~ Pendapatan_Tahunan_Miliar_IDR]()
   - Intepretasi :
